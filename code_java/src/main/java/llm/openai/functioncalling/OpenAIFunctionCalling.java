...
public class OpenAIFunctionCalling {
  ...
  public static void main(String[] args) {
    ...
    ChatCompletionCreateParams.Builder chatBuilder = ChatCompletionCreateParams.builder()
        ...
        .addCustomTool(ChatCompletionToolMessageParam.Function.builder()
            .name("FeatureDataLineage")
            .description("分析特征的血缘关系")
            .build())
        .addTool(ChatCompletionToolMessageParam.Function.builder()
            .name("FeatureDataLineage")
            .description("分析特征的血缘关系")
            .build())
